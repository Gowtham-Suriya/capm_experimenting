...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "mylearningcapmproj/test/integration/FirstJourney",
    "mylearningcapmproj/test/integration/BookSetListJourney",
    "mylearningcapmproj/test/integration/BookSetObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
